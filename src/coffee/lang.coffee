...
###########################################################################################################
    ...
    central_modal:
        ...
        master_ip:"服务器地址"
        mode:"类型"
        tips_ip:"IP地址通常用“点分十进制”表示成（a.b.c.d）的形式，其中，a,b,c,d都是0~255之间的十进制整数。"
        tips_store:"1级集群至少需要4台存储，2级集群至少需要8台存储，3级集群至少需要12台存储。且都为4的倍数。"
        tips_colony:"集群名称为数字"        
        tips_client:"访问地址即空间的入口地址，可为多个。"
...
####################################################
    ...
    central_machine_list:
        title: "系统配置"
        tabletitle:"服务启动"
        machine_error:"请选择机器"
        no_selected:"请选择备份服务器地址"
        same_ip:"备份服务器和主服务器不能相同"
        start_success:"开启成功"
        stop_success:"停止成功"
    ...
    central_warning:
        ...
        warn_range:"阈值的范围为0%~100%。"
        store_only_tip:"此阈值仅作用于存储。"
        email_tip1:"设置需要告警的邮件，当设备出现故障时可第一时间得到通知。"
        email_tip2:"告警等级分为高中低，当设备出现故障时，系统将按照等级从高到低依次发送通知。"
